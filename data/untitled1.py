...
Original file is located at
    https://colab.research.google.com/drive/1t_MLKFUNRg7jTJ7yKcabzu3LpNcTAxgc
"""
...
for column in datetime_columns:
    alldf[column] = pd.to_datetime(alldf[column])
...
# calling functions
daily_orders_df=number_order_per_month(alldf)
most_and_least_products_df=create_by_product_df(alldf)
rating_service,max_score,df_rating_service=rating_cust_df(alldf)
customer_spend_df=customer_spend_df(alldf)
rfm=create_rfm(alldf)
